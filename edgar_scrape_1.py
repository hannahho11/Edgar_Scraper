...
def get_directories(ticker, document, start_year, end_year):
    ...
    for year in range(start_year, end_year+1):
        for quarter in range(1,5):
            ...
            links = page.xpath('//*[@id="main-content"]/table/tr/td/a') #DEBUG any html object: .text_content()
...
def get_10Ks(ticker, start_year, end_year):
    ...
    indexes = []
    for element_list in directories:
        for element in element_list:
            if re.findall('quarterlyindex\d', element.text_content()):
